...
This project presents Fraud Shield, a credit card fraud detection system that combines a Random Forest classifier with a Flask-based monitoring dashboard. It supports single and batch transaction analysis, authentication, risk scoring, alerts, verification, CSV uploads, and downloadable reports.

The model uses 15 engineered transaction and customer-behavior features. Shared preprocessing and scaling ensure consistency between training and prediction. Each transaction receives a fraud probability, model decision, behavior-based risk signals, and a risk score from 0 to 100.

The training dataset contains 60,994 transactions, including 890 fraudulent records (approximately 1.46 percent). Repository evaluation indicates high accuracy and strong fraud-class recall. This documentation is based on the implemented system and the related research paper \cite{shah2025}.
