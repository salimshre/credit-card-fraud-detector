...
The training data stored in \path{creditcard_raw.csv} contains 60,994 transactions, including 890 fraud records, giving a fraud rate of approximately 1.46 percent. The model evaluation reported in the repository shows high overall accuracy while preserving strong fraud-class recall. This documentation is based on the implemented repository and related credit card fraud detection studies on imbalanced transaction classification and Random Forest based detection \cite{mallidi2021analysis,adesina2024creditcard,tadvi2021realtime}.
...
The research basis for this project includes studies on machine learning approaches for credit card fraud detection, including Random Forest classifiers, comparisons across balanced and imbalanced datasets, real-time fraud detection workflows, online payment fraud models, and related academic implementations \cite{lin2021autoencoder,adesina2024creditcard,mallidi2021analysis,maniraj2019creditcard,varunkumar2020creditcard,shukur2019creditcard,tadvi2021realtime,he2022mlmethods,oza2019fraud,almazroi2023onlinepayment,veltech2023creditcard}. The repository extends these ideas by turning the model into a working monitoring application with dashboard, alerts, verification, batch upload, and report generation.
