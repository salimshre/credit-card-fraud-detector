...
The training data stored in \path{creditcard_raw.csv} contains 59,978 synthetic transactions, including 922 fraud records, giving a fraud rate of approximately 1.54 percent. The current repository metadata reports a chronological 70/15/15 train-validation-test split and a recommended fraud probability threshold of approximately 0.371. On the test split, the model records 98.56 percent accuracy, 52.22 percent fraud precision, 68.12 percent fraud recall, 65.22 percent PR-AUC, and 97.32 percent ROC-AUC. These results demonstrate performance on the repository's synthetic benchmark; they should not be interpreted as performance on real bank transaction data. This documentation is based on the implemented repository and related credit card fraud detection studies on imbalanced transaction classification and Random Forest based detection \cite{mallidi2021analysis,adesina2024creditcard,tadvi2021realtime}.
